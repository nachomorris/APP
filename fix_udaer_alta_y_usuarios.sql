-- ============================================================
-- Fix de datos: comercios de UDAER
-- Correr en el SQL Editor de Supabase, EN ESTE ORDEN (ya viene así abajo):
--   1) Alta de las 3 fichas de alojamiento que faltaban.
--   2) Un usuario por cada mail de la planilla UDAER (clave: UDAER),
--      asignado como dueño de su comercio. Si el mail ya existía como
--      usuario, no lo duplica: solo le reasigna el comercio.
--   3) Marca las 43 fichas de UDAER en business_chambers.
-- ============================================================
